...
class BoardController: NSObject,
  ...
  private func applyNumLettersSettings(with settings: [String: Any]) {
    // START YOUR CODE HERE
      guard let numLetters = settings["numLetters"] as? Int else {
        return
      }
  ...
  private func applyNumGuessesSettings(with settings: [String: Any]) {
    // START YOUR CODE HERE
      guard let numGuesses = settings["numGuesses"] as? Int else {
        return
      }
      numRows = numGuesses
    // END YOUR CODE HERE
  ...
  private func applyThemeSettings(with settings: [String: Any]) {
    // START YOUR CODE HERE
      guard let theme = settings["wordTheme"] as? String else {
        return
      }
      let goalTheme = WordTheme(rawValue: theme)!
      self.goalWord = WordGenerator.generateGoalWord(with: goalTheme)
    // END YOUR CODE HERE
  }
  ...
  private func applyIsAlienWordleSettings(with settings: [String: Any]) {
    // START YOUR CODE HERE
      guard let isAlien = settings["isAlienWordle"] as? Bool else {
        return
      }
